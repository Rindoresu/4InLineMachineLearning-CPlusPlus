...
void jugadorGoloso4() {
    ...
    int parametro_oponente_gana = static_cast<int>(-pow(2.0, static_cast<double>(this_game.c+1.0))*10000.0);

    for(int i = 0; i < this_game.c; i++) {
        mi_peso[i] = static_cast<int>(pow(2.0, static_cast<double>(i))*10000.0);
        peso_contrincante[i] = static_cast<int>(-pow(2.0, static_cast<double>(i+1.0))*10000.0);
        C_parametros[i] = static_cast<int>(pow(2.0, static_cast<double>(i))*10000.0);
        C_parametros_oponente[i] = static_cast<int>(-pow(2.0, static_cast<double>(i+1.0))*10000.0);
        C_parametros_oponente_doble[i] = static_cast<int>(-pow(2.0, static_cast<double>(i+1.0))*10000.0);
        C_parametros_peso_particionar[i] = static_cast<int>(30000+i*3000);
    }
    C_parametros[this_game.c-1] = static_cast<int>(pow(2.0, static_cast<double>(this_game.c+2.0))*10000.0);
    /*
    vector<int> mi_peso(this_game.c);
    vector<int> peso_contrincante(this_game.c);
    vector<int> C_parametros(this_game.c);
    ...
    for(int i = 0; i < this_game.c; i++) {
        ...
        C_parametros_oponente[i] = static_cast<int>(-pow(2.0, static_cast<double>(i+1.0))*10000.0);
        C_parametros_oponente_doble[i] = static_cast<int>(-pow(2.0, static_cast<double>(i+1.0))*10000.0);
        C_parametros_peso_particionar[i] = static_cast<int>(pow(golden_ratio, static_cast<double>(i))*10000.0);
    }
    C_parametros[this_game.c-1] = static_cast<int>(pow(2.0, static_cast<double>(this_game.c+2.0))*10000.0);
    *//*
    double golden_ratio = (1.0+pow(5.0,1.0/2.0))/2.0;
    double square_root_of_2 = pow(2.0,1.0/2.0);
    int parametro_oponente_gana = static_cast<int>(-pow(golden_ratio, static_cast<double>(this_game.c+1.0))*10000.0);

    for(int i = 0; i < this_game.c; i++) {
        mi_peso[i] = static_cast<int>(pow(golden_ratio, static_cast<double>(i))*10000.0);
        peso_contrincante[i] = static_cast<int>(-pow(golden_ratio, static_cast<double>(i+1.0))*10000.0);
        C_parametros[i] = static_cast<int>(pow(golden_ratio, static_cast<double>(i))*10000.0);
        C_parametros_oponente[i] = static_cast<int>(-pow(golden_ratio, static_cast<double>(i+1.0))*10000.0);
        C_parametros_oponente_doble[i] = static_cast<int>(-pow(golden_ratio, static_cast<double>(i+1.0))*10000.0);
        C_parametros_peso_particionar[i] = static_cast<int>(pow(square_root_of_2, static_cast<double>(i))*10000.0);
    }
    C_parametros[this_game.c-1] = static_cast<int>(pow(golden_ratio,static_cast<double>(this_game.c+2.0))*10000.0);
    */
...
/* MAINS VIEJOS, ahora mismo no importan*/
...
/*int main() { // ESTE ES EL MAIN ORIGINAL DE LOS PROFES

    std::string msg, color, opponent_color, go_first;
    int columns, rows, c, p, move;

    while (true) {
        color = read_str();
        opponent_color = read_str();
